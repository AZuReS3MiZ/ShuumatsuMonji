...
See Release pages for more info and full preview.<br><br>
注意：我所创作的字体包含片假名、大写字母和ASCII符号等不属于原作（也就是少末动画/漫画），由我创作的字形。<br>
请参照Release页面获取更多信息以及完整预览。
...
## Update Sheldule? / 更新计划？
The category is in a status of "Completement", Which means no major update, only small bug fix in a very long time.<br>
But I'm always learning. If I learn something that can benefit this project, I'll come back and update it.<br><br>
这个项目基本上结束了，除了小bug修复以外，不会有大的更新。<br>
但是如果我学到什么对这个项目有很大提升的东西的话，我会来更新的。

## Bug Report? / 问题报告？
Just throw issues to me. I'll read them.(no guarantee for fixing every issue)<br>
给我扔issues就行，我会看的。（但是不保证一定能改）
